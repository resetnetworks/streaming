...
function Help() {
  ...
  const renderContactInfo = () => (
    <div className="space-y-4">
      <h2 className="text-2xl font-semibold text-white">
        Help & Support – musicreset
      </h2>
      <p className="text-gray-200">
        The official support center for <strong>musicreset</strong> – your platform
        for ambient, instrumental, and experimental music. We're here to help
        with account access, subscriptions, streaming issues, and more.
      </p>

      <p className="text-gray-300 italic">
        If you made a payment but didn’t receive the song or subscription
        access, please contact us with your payment proof. We'll resolve the
  ...
  const leftBoxContent =
    selectedTopicIdx !== null && selectedQuestionIdx !== null
  ...
  return (
    <>
      <Helmet>
        <title>
          Help & Support | musicreset - Reset Music Streaming Platform
        </title>
        ...
        <div className="flex justify-center items-center flex-1 w-full py-8">
          <div className="flex flex-col lg:flex-row gap-6 w-full max-w-6xl">
            ...
            <div className="bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-lg p-5 lg:p-6 flex-1 lg:max-w-[380px] min-h-[400px] max-h-[600px] flex flex-col overflow-auto">
              <h3 className="text-white mb-5 font-semibold text-xl">
