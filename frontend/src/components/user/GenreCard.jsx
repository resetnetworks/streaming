    ...
    <div className="flex flex-shrink-0 gap-4">
      ...
      {first && (
        <div
          ...
          className="sm:h-72 h-52 w-44 sm:w-56 cursor-pointer rounded-none overflow-hidden shadow-lg relative"
          role="button"
          tabIndex={0}
      ...
      <div className="flex flex-col gap-4">
        {rest.map((card, index) => (
          <div
            ...
            className="sm:h-[136px] h-24 w-52 sm:w-72 cursor-pointer rounded-none overflow-hidden shadow-lg relative"
            role="button"
            tabIndex={0}
