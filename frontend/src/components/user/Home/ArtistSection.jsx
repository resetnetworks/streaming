...
const ArtistCircle = forwardRef(function ArtistCircle(
  ...
  return (
    <button
      ...
      type="button"
      onClick={onClick}
      className="group relative sm:w-48 sm:h-48 h-32 w-32 shrink-0 rounded-full focus:outline-none focus-visible:ring-4 focus-visible:ring-[#4DB3FF]/80 transition-shadow duration-300 ease-in-out"
