    ...
    <>
      ...
      <div
        className={`fixed inset-0 z-[998] transition-all duration-300 ease-out ${
          isClosing ? "opacity-0" : "bg-black/60 backdrop-blur-sm"
        }`}
        onClick={handleClose}
      />
            ...
            <div className="relative overflow-hidden h-full">
              ...
              <div className="px-6 pb-4 relative">
                <div className="flex flex-col gap-4">
                  ...
                  >
                    <div
                      className={`button-wrapper w-12 h-12 rounded-lg ${
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-white">DJ Mix</h3>
                      <p className="text-xs text-gray-300 mt-0.5">
                        Upload DJ mix or mashup
                      </p>
                    </div>
                    ...
                    <div className="play-pause-wrapper w-6 h-6 rounded-full">
                      <div
                        className={`w-full h-full rounded-full flex items-center justify-center ${
                          selectedType === "mix" ? "bg-blue-500" : "bg-gray-800"
                        }`}
                      >
                        {selectedType === "mix" && (
                          <IoCheckmark className="text-xs text-white" />
