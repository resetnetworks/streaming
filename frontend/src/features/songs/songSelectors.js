...
export const selectSongsPagination = (state) => state.songs.pagination;
...
export const selectTotalPages = (state) => state.songs.pagination.totalPages;
export const selectCurrentPage = (state) => state.songs.pagination.page;
...
// ✅ Cache selectors for paginated songs (NOT LIKED SONGS)
...
// ✅ Cache utility selectors for paginated songs only
...
// ✅ REMOVED ALL LIKED SONGS CACHE SELECTORS
